  ...
  render() {
    ...
    return (
      ...
      >
          ...
          {!smallest ? (
            ...
            >
              <div className="flex">
                ...
                <Link className="navbar-item flex items-center no-underline" to="/pictures">
                  Pictures
                </Link>
        ...
        {open && (
          <SmallMenu
            sections={[{ title: 'Reserve Turf', link: 'turf-space' }, { title: 'About', link: 'about' }, { title: 'Pictures', link: 'pictures' }]}
